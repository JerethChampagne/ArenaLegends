...
public class VoidVector : SpellVector 
{

    private GameObject target;
    private GameObject spEffect;

    public VoidVector(float damage, float cost, float effect, GameObject spellEffect, GameObject tar) : base(damage, cost, effect) 
    {
        this.target = tar;
