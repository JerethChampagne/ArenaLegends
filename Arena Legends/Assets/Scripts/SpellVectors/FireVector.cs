...
public class FireVector : SpellVector
{

    private GameObject target;
    private GameObject spEffect;

    public FireVector(float damage, float cost, float effect, GameObject spellEffect, GameObject tar) : base(damage, cost, effect) 
    {
        this.target = tar;
